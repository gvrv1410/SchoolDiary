                ...
                <View
                    ...
                    <View
                        ...
                        <View style={{ alignItems: 'center', marginTop: Height(30) }}>
                            ...
                            <Text style={{ fontSize: Height(25), fontFamily: fonts.ARCHIVO_MEDIUM, color: colors.textColor, marginTop: Height(50), textAlign: 'center' }}>{displayMsg}</Text>
                        </View>
                        <TouchableOpacity style={styles.btn} onPress={() => dismissAlert(false)}>
                            <LinearGradient
                                colors={[
