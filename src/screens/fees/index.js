    ...
    <View style={globalstyles.container}>
      ...
      <View style={styles.view}>
        <Text style={styles.text}>
          Name: <Text style={styles.subText}>{Student.S_name}</Text>
        </Text>
        <Text style={styles.text}>
          Std : <Text style={styles.subText}>{separatedValue}</Text>
        </Text>
        <Text style={styles.text}>
          Class : <Text style={styles.subText}>{separatedValue1}</Text>
        </Text>
      </View>
      <View style={styles.feesView}>
        <Text style={styles.feesText}>Annual</Text>
        <Text style={[styles.feesText, { fontSize: Height(15) }]}>
          30,000/-
        </Text>
      </View>
      <DropShadow style={globalstyles.dropShadow}>
        <View style={[styles.feesView, { backgroundColor: colors.whiteColor }]}>
          <Text style={[styles.feesText, { color: colors.blackColor }]}>
            Annual
          </Text>
          <Text
            style={[
              styles.feesText,
              { fontSize: Height(15), color: colors.blackColor },
            ]}
          >
            10,000/-
          </Text>
