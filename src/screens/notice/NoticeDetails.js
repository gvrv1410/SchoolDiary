...
const styles = StyleSheet.create({
    ...
    text: {
        fontSize: Height(20), fontFamily: fonts.ARCHIVO_MEDIUM, paddingHorizontal: Width(20), marginTop: Height(30)
    },
    subText: {
        fontSize: Height(12), fontFamily: fonts.ARCHIVO_REGULAR, color: colors.blackColor, letterSpacing: 0.2, paddingHorizontal: Width(20), marginTop: Height(5)
    },
    pdfView: {
        height: Height(500), width: Width(350), alignSelf: 'center', marginTop: Height(30), flex: 1
    },
    imgView: {
        height: Height(500), width: Width(350), alignSelf: 'center', marginTop: Height(30), resizeMode: 'contain'
    }
})