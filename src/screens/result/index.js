...
const styles = StyleSheet.create({
    ...
    view: {
        height: Height(55), width: Width(200), backgroundColor: colors.whiteColor, justifyContent: 'center', alignItems: 'center', borderRadius: Width(5), alignSelf: 'center', marginTop: Height(20)
    },
    viewText: {
        fontSize: Height(20), fontFamily: fonts.ARCHIVO_SEMIBOLD, color: colors.textColor
    },
    text: {
        fontSize: Height(18), fontFamily: fonts.ARCHIVO_SEMIBOLD, textAlign: 'center', marginTop: Height(20)
    }, pdf: {
        height: Height(200),
        width: Width(350),
        alignSelf: 'center',
