  ...
  return (
    <View style={globalstyles.container}>
      ...
      <View style={styles.view}>
        ...
        <View>
          {fatherImage ? (
            <Image source={{ uri: fatherImage }} style={styles.image} />
          ) : (
            <Image
              source={
                Student
        ...
        <View>
          {motherImage ? (
            <Image source={{ uri: motherImage }} style={styles.image} />
          ) : (
            <Image
              source={
                Student
      ...
      <DropShadow style={globalstyles.dropShadow}>
        <View style={styles.subView}>
          ...
          <View style={styles.rowView}>
            ...
            <Text style={[styles.vText, { width: Width(180) }]}>
              {Student && Student.S_address}
            </Text>
          </View>
        </View>
      </DropShadow>
